...
<head>
    ...
    <title>Shop Now | Dashboard</title>
    <style>
        ...
        <form id="add_form" action="php/add_product.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="content">
                <div class="inputs">
                    ...
                    <div class="input-line">
                        <p>Category</p><span>: <input name="category" type="text"></span>
                    </div>
                    <div class="input-line">
        ...
        <form id="edit_form" action="php/edit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="content">
                <div class="inputs">
                    ...
                    <div class="input-line">
                        <p>Category</p><span>: <input name="Category" class="Category" type="text"></span>
                    </div>
                    <div class="input-line">
    ...
    <div id="product-pop-up">
        ...
        <div class="product-info">
            ...
            <div class="product-content">
                <p class="name">SWEAT EN MAILLE</p>
                <p class="price">30$</p>
                <p class="quantity">39</p>
                <p class="Category">Tops</p>
                
                <p class="owner">Rachid</p>
            </div>
        </div>
